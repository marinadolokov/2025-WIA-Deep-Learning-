...
params = dict(
  ...
  hidden_size = 64,  # Experiment between 1 and 2048
  num_layers = 6, # Number of layers
  NumberOfEpochs = 2, #Number of epochs
  ...
  standarize = False,
  normalization = True,
  scale = True, scale_range = (0.8, 2.5), accelerations_to_scale = [1,4], phys_scale_factors = [1, 0.4, 0.2],
